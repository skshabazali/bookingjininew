    ...
    render() {
        ...
        return (
            <TouchableOpacity onLongPress={()=>{
                console.log(url+port+"/resolve-customer-requests/?message_id="+this.props.value.msg_id)
                let urls=url+port+"/resolve-customer-requests/?message_id="+this.props.value.msg_id
