...
class Request extends Component {
    ...
    callApi(){
      ...
      console.log(url+port+"/get-customer-requests/?auth_key="+uid)
      Axios.get(url+port+"/get-customer-requests/?auth_key="+uid).then((Response)=>{
    ...
    registerFood(){
      Axios.get(url+port+'/add-new-menu-item/?name='+this.state.name+'&price='+this.state.price).then((Response)=>{
        if(Response.data)
        {
          this.setState({
            showResturantForm:false,
