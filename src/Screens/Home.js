...
callapi() {
        ...
        // console.log(url+'/get-waiting-key-at-hotel/?auth_key='+uid);
        // let urls=url+'/get-waiting-key-at-hotel/?auth_key='+uid
        // console.log(urls)
        axios.get(url+port+'/get-waiting-key-at-hotel/?auth_key='+uid)
  .then((response)=>{
    let b =[]
...
//     }
  ...
  axios.get(url+port+"/hotel-kpis/?auth_key="+uid).then((Response)=>{
        this.setState({
          kpis:Response.data
        })
    }).catch((error)=>{
